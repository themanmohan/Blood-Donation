...
//save life button
	...
	<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Are you Sure  Update this account this record?</strong>
    ...
    if(isset($_POST['userID'])){
        ...
        $sql = "UPDATE donor SET life_save_date=' $crntDate' WHERE ID='$userID'";
        
        if(mysqli_query($connection,$sql)){
            $_SESSION['life_save_date']=$crntDate; 
...
<div class="container" style="padding: 60px 0;">
            ...
            <div class="col-md-12 col-md-push-1">
                <div class="panel panel-default" style="padding: 20px;">
                    <div class="panel-body">
                        ...
                        <!--                   save the life button-->
                        <?php 
                                                                
                    $safeDate =  $_SESSION['life_save_date'];
    ...
    <div class="donors_data">
        ...
        <span>You successfully Submit Update Your Account Now Donate Blood After Three Month</span </div> </div>';
